...
public interface QLog {
    ...
    void emitRttMetrics(int smoothedRtt, int rttVar, int latestRtt);

    void emitRecoveryMetrics(long congestionWindow, long bytesInFlight, int smoothedRtt, int rttVar, int latestRtt);
