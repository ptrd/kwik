...
import static net.luminis.quic.QuicConstants.TransportParameterIdPreDraft17.*;

// https://tools.ietf.org/html/draft-ietf-quic-transport-16#section-18
public class QuicTransportParametersExtensionPreDraft17 extends Extension {

    private byte[] data;

    public QuicTransportParametersExtensionPreDraft17() {
    }
     ...
     * @param quicVersion
     */
    public QuicTransportParametersExtensionPreDraft17(Version quicVersion) {
        ...
        buffer.putShort(QuicConstants.TransportParameterIdPreDraft17.initial_max_stream_data_bidi_local.value);
        // https://tools.ietf.org/html/draft-ietf-quic-transport-16#section-18.1:
        ...
        buffer.putShort(QuicConstants.TransportParameterIdPreDraft17.initial_max_stream_data_bidi_remote.value);
        // https://tools.ietf.org/html/draft-ietf-quic-transport-16#section-18.1:
        // "Either peer MAY advertise an initial value for flow control of each type of stream on which they might receive data.
        // Each of the following transport parameters is encoded as an unsigned 32-bit integer in units of octets: ..."
        buffer.putShort((short) 4);
        ...
        buffer.putShort(QuicConstants.TransportParameterIdPreDraft17.initial_max_stream_data_uni.value);
        // https://tools.ietf.org/html/draft-ietf-quic-transport-16#section-18.1:
        // "Either peer MAY advertise an initial value for flow control of each type of stream on which they might receive data.
        // Each of the following transport parameters is encoded as an unsigned 32-bit integer in units of octets: ..."
        buffer.putShort((short) 4);
        ...
        buffer.putShort(QuicConstants.TransportParameterIdPreDraft17.initial_max_uni_streams.value);
        // https://tools.ietf.org/html/draft-ietf-quic-transport-16#section-18.1:
