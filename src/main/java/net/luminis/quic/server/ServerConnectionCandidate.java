...
public class ServerConnectionCandidate implements ServerConnectionProxy {
    ...
    public void parsePackets(int datagramNumber, Instant timeReceived, ByteBuffer data) {
        ...
        // TODO: difference with previous version is that parseAndProcessPackets is now executed on receiver thread.... ;-(
        ...
        if (registeredConnection != null) {
            ...
            System.out.println("ServerConnectionCandidate.parsePackets: delegating to existing connection!");
        ...
        try {
            ...
            ServerConnectionImpl connection = createAndRegisterServerConnection(initialPacket);
            ...
            connection.parseAndProcessPackets(datagramNumber, timeReceived, data, initialPacket);
        }
    ...
    private ServerConnectionImpl createAndRegisterServerConnection(InitialPacket initialPacket) {
        ...
        registeredConnection = new ServerConnectionThread(connection);
        // Register new connection the new connection id (the one generated by the server)
        connectionRegistry.registerConnection(registeredConnection, connection.getConnectionId());
        return connection;
    }
