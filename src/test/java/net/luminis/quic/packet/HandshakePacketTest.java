...
class HandshakePacketTest {
    ...
    void decrypt1() throws Exception {
        ...
        ConnectionSecrets connectionSecrets = new ConnectionSecrets(Version.IETF_draft_29, Role.Client, null, mock(Logger.class));
        ...
        HandshakePacket handshakePacket = new HandshakePacket(Version.IETF_draft_29);
