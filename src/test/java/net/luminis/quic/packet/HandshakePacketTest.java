...
class HandshakePacketTest {
    ...
    void decrypt1() throws Exception {
        ...
        when(tlsState.getClientHandshakeTrafficSecret()).thenReturn(ByteUtils.hexToBytes("fdb5d43527aa9788cda8f8c00a56932f262ff48c43751de8939f14224788533f"));
        when(tlsState.getServerHandshakeTrafficSecret()).thenReturn(ByteUtils.hexToBytes("7021d58745bcb58ad38b442707e425a30d1cba3cde541c159d0d9d2d647ff9f2"));
        connectionSecrets.computeHandshakeSecrets(tlsState, TlsConstants.CipherSuite.TLS_AES_128_GCM_SHA256);
    ...
    void decrypt3() throws Exception {
        ...
        TlsState tlsState = mock(TlsState.class);
        when(tlsState.getClientHandshakeTrafficSecret()).thenReturn(ByteUtils.hexToBytes("715177001489f23cf6922c83edfcb4ceb037c4a0a9088d91dda4bb96694cdfd0"));
        when(tlsState.getServerHandshakeTrafficSecret()).thenReturn(ByteUtils.hexToBytes("4cc9aad05d0b0d5fb07afbe4a40e4584cab6dc1f41fb6c79c78d3f7f834b0220"));
        connectionSecrets.computeHandshakeSecrets(tlsState, TlsConstants.CipherSuite.TLS_AES_128_GCM_SHA256);
