...
class ServerConnectionFactoryTest {
    ...
    void newConnectionHasRandomSourceConnectionId() {
        ServerConnectionFactory connectionFactory = new ServerConnectionFactory(16, null, tlsServerEngineFactory, 100, cid -> {}, mock(Logger.class));
    ...
    void connectionFactorySupportsConnectionIdsWithSmallLength() {
        ServerConnectionFactory connectionFactory = new ServerConnectionFactory(4, null, tlsServerEngineFactory, 100, cid -> {}, mock(Logger.class));
        ServerConnection conn1 = connectionFactory.createNewConnection(Version.getDefault(), null, new byte[8], new byte[8]);
    ...
    void connectionFactorySupportsConnectionIdsWithLargeLength() {
        ServerConnectionFactory connectionFactory = new ServerConnectionFactory(20, null, tlsServerEngineFactory, 100, cid -> {}, mock(Logger.class));
        ServerConnection conn1 = connectionFactory.createNewConnection(Version.getDefault(), null, new byte[8], new byte[8]);
    ...
    void connectionFactoryWillNotAcceptConnectionLengthLargerThan20() {
        assertThatThrownBy(() ->
                new ServerConnectionFactory(21, null, tlsServerEngineFactory, 100, cid -> {}, mock(Logger.class))
